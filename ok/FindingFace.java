...
//		FImage imageee = ImageUtilities.readF(new File("F:\\大学\\大数据\\Final_Project\\奥巴马\\2.jpg"));
		...
		//MBFImage imageee = ImageUtilities.readMBF(new File("/Users/Phoenix/OpenIMAJ-Phoenix/src/main/java/ok/testfaces/s1/1.pgm"));
		
		MBFImage imageee = ImageUtilities.readMBF(new File("/Users/Phoenix/OpenIMAJ-Phoenix/src/main/java/ok/Mike/04.jpg"));
		FaceDetector <DetectedFace,FImage> displays = new HaarCascadeDetector(40);
